         ...
         <div className={styles.titles__main}>
            <div className={styles.titles__elem}>
               ...
               <div
                  className={`${styles.titles__elemFiller} ${
                     !maxHeight && scrollPosition > 16.5 ? styles.titles__elemFillerActive : ""
                  } ${maxHeight && scrollPosition > 15.9 ? styles.titles__elemFillerActiveMedia : ""}`}
               >
                  Midea MagBoost - это прорыв в системах охлаждения,
               </div>
            </div>
            <div className={styles.titles__elem}>
               ...
               <div
                  ...
                  } ${maxHeight && scrollPosition > 16 ? styles.titles__elemFillerActiveMedia : ""}`}
               >
                  который навсегда изменит ваши представления о
               </div>
            </div>
            <div className={styles.titles__elem}>
               ...
               <div
                  className={`${styles.titles__elemFiller} ${
                     !maxHeight && scrollPosition > 18 ? styles.titles__elemFillerActive : ""
                  } ${maxHeight && scrollPosition > 16.4 ? styles.titles__elemFillerActiveMedia : ""}`}
               >
                  надежности и эффективности
               </div>
            </div>
